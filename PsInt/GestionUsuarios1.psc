Algoritmo GestionUsuarios1
    Definir opcion, i, j, indice COMO ENTERO;
    Definir run, nombre, fechaNacimiento, direccion, telefono, cantidadEmpleados, departamento, funcionUsuario, nombreSuperior, rutModificar, rutEliminar COMO CADENA;
