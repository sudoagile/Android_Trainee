...
Algoritmo grupal_06
	...
	Escribir "Ingresar numero de usuarios (max 100, por defecto 3)"; 
	Leer num_usuarios;
	Mientras num_usuarios > 100 Hacer
	...
	// Rutina para mostrar todos los datos almacenatipodos
...
SubAlgoritmo pantallaInicial
	...
	texto = "Big Brother Software Corporation, presenta:";
	subtitle = "EJERCICIO GRUPAL N° 6";
	subtitle2 = "<<  Grupo 6  >>";
	max = Longitud(texto);
	j = 0;
